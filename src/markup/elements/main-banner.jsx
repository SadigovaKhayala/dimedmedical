...
import doctorImg from '../../images/main-banner/doctorr.png'
        ...
        >
          <div className="container inner-content">
            <div className="row align-items-center">
              <div className="col-lg-7 col-md-6 col-sm-7 mt-5 mb-4">
                <h6 className="title-ext text-primary">
                  Biz sizin üçün ən yaxşısını etməyə çalışırıq.
                </h6>
                <h1>Sağlamlığınızı bizə həvalə edin </h1>
                <Link
                  to="/about-us"
